...
func (c *Client) CreateReviewRequests(owner, repo string, index int64, opt PullReviewRequestOptions) ([]PullReview, *Response, error) {
	if err := escapeValidatePathSegments(&owner, &repo); err != nil {
		return nil, nil, err
	}
