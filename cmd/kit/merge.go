...
func KitMergeCommand(config *specs.MarkDevkitConfig) *cobra.Command {
	...
	var cmd = &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			log := logger.GetDefaultLogger()
			specfile, _ := cmd.Flags().GetString("specfile")
			kitfile, _ := cmd.Flags().GetString("summary-file")
			...
			mergeOpts.KitCloneSummaryFile = kitfile
	...
	flags.String("summary-file", "", "The summary file generated by kit clone (optional).")
