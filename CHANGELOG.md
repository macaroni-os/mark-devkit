...
# Release 0.32.0 - Jun 6, 2026

* Renderize `slot` variable with Helm engine

* `kit merge`: Added flag `--summary-file <filepath>`
  in order to using specific commit sha on merge phase
  through the file generated by the `kit clone`
  command.
